...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 ./.build/android/release-unsigned.apk pizzar -keystore ./.bin/pizzar.keystore
$ANDROID_HOME/build-tools/25.0.3/zipalign 4 ./.build/android/release-unsigned.apk ./.build/android/release.apk

jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 ./.build/android/project/build/outputs/apk/release/android-release-unsigned.apk pizzar -keystore ./.bin/pizzar.keystore
